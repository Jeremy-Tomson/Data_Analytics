...
namespace DataAnalytics
{
    public partial class Form1 : Form
    {
        ...
        float[,] xycoords = new float[60, 2];
        float[,] xyavg = new float[57, 2];
        float[,] trcoords = new float[60, 2];
        ...
        public void XYStd()
        {
            ...
            chart4.ChartAreas["area11"].AxisX.Interval = 10;
            chart4.ChartAreas["area11"].AxisX.Maximum = 60;
            chart4.ChartAreas[0].AxisX.Title = "Period [Months]";

            chart4.ChartAreas["area11"].AxisY.Minimum = -100;
            chart4.ChartAreas["area11"].AxisY.Interval = 20;
            chart4.ChartAreas["area11"].AxisY.Maximum = 100;
            chart4.ChartAreas[0].AxisY.Title = "Arrivals";

            chart4.Series["Average"].Color = Color.DeepSkyBlue;

            chart4.Series["Average"].ChartType = System.Windows.Forms.DataVisualization.Charting.SeriesChartType.Spline;
            ...
            for (int i = 0; i < 59; i++)
            {
                ...
                this.chart3.Series["Detrend"].Points.AddXY(trcoords[i, 0], 1);
            }
        }
